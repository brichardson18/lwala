  ...
  fields(
    ...
    field("Basic_Information", function(state){
      return{
        ...
        "Ever_on_Family_Planning":dataValue("new[0].Ever_on_Family_Planning__c")(state),
        "Currently_on_family_planning":dataValue("new[0].Family_Planning__c")(state),
        "Family_Planning_Method":dataValue("new[0].Family_Planning_Method__c")(state)
      };
    }),
    ...
    field("HAWI", function(state){
      return{
        ...
        "Active_in_Support_Group":dataValue("new[0].Active_in_Support_Group__c")(state),
        ...
        "n0:case":{
          ...
          "n0:update": {
            ...
            "n0:Client_Program": function(){
              var program='';
              if(dataValue("new[0].Active_in_Thrive_Thru_5__c"||dataValue("new[0].Active_TT5_Mother__c")(state)=="Yes")(state)=="Yes"){
                if(dataValue("new[0].Active_in_HAWI__c")(state)=="Yes"){
                  program="Both";
                }
                else{
            ...
            "n0:Active_in_HAWI__c":dataValue("new[0].Active_in_HAWI__c")(state),
